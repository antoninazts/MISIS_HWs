...
# и хочу оставить универсальное решение
print("\nЗадача 7.1 Сумма и произведение цифр в числе")
a = list(input("Введите положительное число: "))
sum7 = 0
m = 1
...
print("\nЗадача 11.")
print("писать через запятую")
a = list(input("Государствa: ").split(",")) #можно сделать пользовательскую multi_split(),
# в следующий раз
